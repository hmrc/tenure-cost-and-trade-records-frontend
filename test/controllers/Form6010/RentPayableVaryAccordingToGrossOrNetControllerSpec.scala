...
class RentPayableVaryAccordingToGrossOrNetControllerSpec extends AnyFlatSpec with should.Matchers with GuiceOneAppPerSuite {
  ...
  object TestData {
    ...
    val baseFormData: Map[String, String] = Map(
      "rentPayableVaryAccordingToGrossOrNet" -> "yes")
  }
}
