...
class CostOfSales6076IntermittentControllerSpec extends ControllerSpec:
  ...
  "GET /" should {
    "return 200" in {
      val result = costOfSales6076IntermittentController.show(getRequest)
    ...
    "render back link to CYA if come from CYA" in {
      val result  = costOfSales6076IntermittentController.show(getRequestFromCYA)
