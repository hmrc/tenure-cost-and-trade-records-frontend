...
class AddAnotherLowMarginFuelCardsDetailsControllerSpec extends ControllerSpec:
  ...
  "AddAnotherLowMarginFuelCardsDetailsController GET /" should {
    "return 200 and HTML with Can Rent Be Reduced On Review in the session  return 200" in {
      val result = createAddAnotherLowMarginFuelCardsDetailsController().show(0)(getRequest)
  ...
  "AddAnotherLowMarginFuelCardsDetailsController SUBMIT /" should {
    "throw a BAD_REQUEST if an empty form is submitted" in {
      val result = createAddAnotherLowMarginFuelCardsDetailsController().submit(1)(getRequest)
  ...
  "Remove LowMargin fuel card details" should {
    "render the removal confirmation page on remove" in {
      ...
      val idxToRemove    = 0
      val sessionRequest = SessionRequest(aboutYourTradingHistoryWithLowMarginFuelCardsDetailsSession, getRequest)
