...
class LowMarginFuelCardDetailsFormSpec extends TestBaseSpec {
  ...
  "LowMarginFuelCardDetailsForm" should {
    ...
    "bind valid data correctly" in {
      ...
      form.value  shouldBe Some(LowMarginFuelCardDetail("Valid Name", BigDecimal(100.50)))
    }
    ...
    "unbind valid data correctly" in {
      val model = LowMarginFuelCardDetail("Valid Name", BigDecimal(100.50))
      val form  = LowMarginFuelCardDetailsForm.lowMarginFuelCardDetailsForm.fill(model)
