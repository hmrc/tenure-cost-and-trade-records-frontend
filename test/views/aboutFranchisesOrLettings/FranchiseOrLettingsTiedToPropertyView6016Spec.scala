...
class FranchiseOrLettingsTiedToPropertyView6016Spec extends QuestionViewBehaviours[AnswersYesNo]:
  ...
  private def createView: () => Html =
    () => franchiseOrLettingsTiedToPropertyView(form, FOR6016, backLink, Summary("99996016001"))(using getRequest, messages)

  private def createViewUsingForm: Form[AnswersYesNo] => Html =
    form => franchiseOrLettingsTiedToPropertyView(form, FOR6016, backLink, Summary("99996016001"))(using getRequest, messages)
