...
class AtmLettingViewSpec extends QuestionViewBehaviours[ATMLetting] {
  ...
  def createView = () => AtmLettingView(form, Some(0), backLink, Summary("99996010001"))(fakeRequest, messages)

  def createViewUsingForm = (form: Form[ATMLetting]) =>
    AtmLettingView(form, Some(0), backLink, Summary("99996010001"))(fakeRequest, messages)
