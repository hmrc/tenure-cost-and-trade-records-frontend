...
class FranchiseOrLettingsTiedToPropertyView6030Spec extends QuestionViewBehaviours[AnswersYesNo]:
  ...
  private def createView: () => Html =
    () => franchiseOrLettingsTiedToPropertyView(form, FOR6030, backLink, Summary("99996030001"))(using getRequest, messages)

  private def createViewUsingForm: Form[AnswersYesNo] => Html =
    form => franchiseOrLettingsTiedToPropertyView(form, FOR6030, backLink, Summary("99996030001"))(using getRequest, messages)
