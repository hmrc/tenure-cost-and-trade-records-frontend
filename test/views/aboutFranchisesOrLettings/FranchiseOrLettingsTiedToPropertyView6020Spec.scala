...
class FranchiseOrLettingsTiedToPropertyView6020Spec extends QuestionViewBehaviours[AnswersYesNo]:
  ...
  private val messageKeyPrefix = "franchiseLettings.6020"
  ...
  private def createView: () => Html =
    () => franchiseOrLettingsTiedToPropertyView(form, FOR6020, backLink, Summary("99996020001"))(using getRequest, messages)

  private def createViewUsingForm: Form[AnswersYesNo] => Html =
    form => franchiseOrLettingsTiedToPropertyView(form, FOR6020, backLink, Summary("99996020001"))(using getRequest, messages)
