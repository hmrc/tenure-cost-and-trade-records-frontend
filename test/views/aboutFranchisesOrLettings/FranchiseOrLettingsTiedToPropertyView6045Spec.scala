...
class FranchiseOrLettingsTiedToPropertyView6045Spec extends QuestionViewBehaviours[AnswersYesNo]:
  ...
  private val messageKeyPrefix = "franchiseLettings.6045"
  ...
  private def createView: () => Html =
    () => franchiseOrLettingsTiedToPropertyView(form, FOR6045, backLink, Summary("99996045001"))(using getRequest, messages)

  private def createViewUsingForm: Form[AnswersYesNo] => Html =
    form => franchiseOrLettingsTiedToPropertyView(form, FOR6045, backLink, Summary("99996045001"))(using getRequest, messages)
