...
class FurtherInformationOrRemarksViewSpec extends QuestionViewBehaviours[String]:
  ...
  def createView: () => Html =
    () => furtherInformationOrRemarksView(form, Summary("99996010001"))(using getRequest, messages)

  def createViewUsingForm: Form[String] => Html =
    form => furtherInformationOrRemarksView(form, Summary("99996010001"))(using getRequest, messages)
  ...
  "Further Information or Remarks view" should {
    ...
    "Section heading is visible" in {
      ...
      html shouldBe s"""<span class="govuk-visually-hidden">This section is </span>${messages("label.section.additionalInformation")}"""
    }
