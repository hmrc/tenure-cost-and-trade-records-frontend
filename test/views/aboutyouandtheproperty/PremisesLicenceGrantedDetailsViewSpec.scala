...
class PremisesLicenceGrantedDetailsViewSpec extends QuestionViewBehaviours[String]:
  ...
  private def createView = () =>
    premisesLicenceGrantedDetailsView(form, Summary("99996010001"))(using getRequest, messages)
  ...
  "Property licence granted view" should {
    ...
    behave like pageWithBackLink(createView, "Premises License Granted", controllers.aboutyouandtheproperty.routes.PremisesLicenseGrantedController.show().url)
