...
class PropertyCurrentlyUsedViewSpec extends QuestionViewBehaviours[PropertyCurrentlyUsed]:
  ...
  private def createView: () => Html =
    () => propertyCurrentlyUsedView(form, Summary("99996045001"), "backLink")(using getRequest, messages)

  private def createViewUsingForm: Form[PropertyCurrentlyUsed] => Html =
    form => propertyCurrentlyUsedView(form, Summary("99996045001"), "backLink")(using getRequest, messages)
