...
class LicensableActivitiesViewSpec extends QuestionViewBehaviours[AnswersYesNo]:
  ...
  private def createView: () => Html =
    () => licensableActivitiesView(form, Summary("99996010001"))(using getRequest, messages)

  private def createViewUsingForm: Form[AnswersYesNo] => Html =
    form => licensableActivitiesView(form, Summary("99996010001"))(using getRequest, messages)
