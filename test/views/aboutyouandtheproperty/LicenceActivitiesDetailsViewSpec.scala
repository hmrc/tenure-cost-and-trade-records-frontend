...
class LicenceActivitiesDetailsViewSpec extends QuestionViewBehaviours[String]:
  ...
  private def createView: () => Html =
    () => licensableActivitiesDetailsView(form, Summary("99996010001"))(using getRequest, messages)

  private def createViewUsingForm: Form[String] => Html =
    form => licensableActivitiesDetailsView(form, Summary("99996010001"))(using getRequest, messages)
