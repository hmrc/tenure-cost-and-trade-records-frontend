...
class CurrentLeaseOrAgreementBeginViewSpec extends QuestionViewBehaviours[CurrentLeaseOrAgreementBegin]:
  ...
  private def createView = () =>
    currentLeaseOrAgreementBeginView(form, Summary("99996010001"))(using getRequest, messages)
  ...
  "Current rent first paid view" should {
    ...
    behave like pageWithBackLink(createView, "Current Rent First Paid", controllers.aboutYourLeaseOrTenure.routes.CurrentRentFirstPaidController.show().url)
