...
class PropertyUpdatesViewSpec extends QuestionViewBehaviours[AnswersYesNo]:
  ...
  private def createView = () =>
    propertyUpdatesView(form, Summary("99996010001"), backLink)(using getRequest, messages)
  ...
  "Property update view" should {
    ...
    behave like pageWithBackLink(createView, "Can Rent Be Reduced On Review", backLink)
