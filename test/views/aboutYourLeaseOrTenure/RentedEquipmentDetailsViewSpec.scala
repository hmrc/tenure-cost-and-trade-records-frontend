...
class RentedEquipmentDetailsViewSpec extends QuestionViewBehaviours[String]:
  ...
  def createView: () => Html = () =>
    rentedEquipmentDetailsView(form, backLink, Summary("99996010001"))(using getRequest, messages)

  def createViewUsingForm: Form[String] => Html =
    form => rentedEquipmentDetailsView(form, backLink, Summary("99996010001"))(using getRequest, messages)
