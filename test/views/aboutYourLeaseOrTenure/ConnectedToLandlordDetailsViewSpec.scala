...
class ConnectedToLandlordDetailsViewSpec extends QuestionViewBehaviours[String]:
  ...
  private def createView = () =>
    connectedToLandlordDetailsView(form, Summary("99996010001"))(using getRequest, messages)
  ...
  "Connected to landlord details view" should {
    ...
    behave like pageWithBackLink(createView, "Connected to landlord", controllers.aboutYourLeaseOrTenure.routes.ConnectedToLandlordController.show().url)
