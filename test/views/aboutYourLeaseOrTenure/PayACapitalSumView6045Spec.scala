...
class PayACapitalSumView6045Spec extends QuestionViewBehaviours[PayACapitalSumDetails] {
  ...
  def createView = () => payACapitalSumView(form, "FOR6045", backLink, Summary("99996045001"))(fakeRequest, messages)

  def createViewUsingForm = (form: Form[PayACapitalSumDetails]) =>
    payACapitalSumView(form, "FOR6045", backLink, Summary("99996045001"))(fakeRequest, messages)
