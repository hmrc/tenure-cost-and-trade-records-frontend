...
class IncentivesPaymentsConditionsViewSpec extends QuestionViewBehaviours[AnswersYesNo]:
  ...
  private def createView = () =>
    incentivesPaymentsConditionsView(form, Summary("99996010001"))(using getRequest, messages)
  ...
  "Incentives payment conditions view" should {
    ...
    behave like
      pageWithBackLink(createView, "Can Rent Be Reduced On Review", controllers.aboutYourLeaseOrTenure.routes.CanRentBeReducedOnReviewController.show().url)
