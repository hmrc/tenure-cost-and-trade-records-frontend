...
class CapitalSumDescriptionViewSpec extends QuestionViewBehaviours[CapitalSumDescription] {
  ...
  def createView = () => capitalSumDescriptionView(form, Summary("99996010001"))(fakeRequest, messages)

  def createViewUsingForm = (form: Form[CapitalSumDescription]) =>
    capitalSumDescriptionView(form, Summary("99996010001"))(fakeRequest, messages)
