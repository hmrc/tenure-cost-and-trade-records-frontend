...
class CapitalSumDescriptionViewSpec extends QuestionViewBehaviours[String]:
  ...
  private val sessionRequest = SessionRequest(stillConnectedDetails6020YesSession, getRequest)
  ...
  "Capital sum description view" should {
    ...
    behave like pageWithBackLink(createView, "Pay A Capital Sum", controllers.aboutYourLeaseOrTenure.routes.PayACapitalSumController.show().url)
