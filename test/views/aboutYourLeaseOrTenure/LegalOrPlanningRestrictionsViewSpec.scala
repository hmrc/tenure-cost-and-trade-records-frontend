...
class LegalOrPlanningRestrictionsViewSpec extends QuestionViewBehaviours[AnswersYesNo]:
  ...
  private def createView = () =>
    legalOrPlanningRestrictionsView(form, backLink, Summary("99996010001"))(using getRequest, messages)
  ...
  "Legal or planning restrictions view" should {
    ...
    behave like pageWithBackLink(createView, "Payment When Lease Is Granted", backLink)
