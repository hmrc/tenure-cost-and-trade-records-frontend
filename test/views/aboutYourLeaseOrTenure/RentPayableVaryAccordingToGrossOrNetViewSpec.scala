...
class RentPayableVaryAccordingToGrossOrNetViewSpec extends QuestionViewBehaviours[AnswersYesNo]:
  ...
  private def createView = () =>
    rentPayableVaryAccordingToGrossOrNetView(form, backLink, Summary("99996010001"))(using getRequest, messages)
  ...
  "Rent payable vary on gross or net turnover view" should {
    ...
    behave like pageWithBackLink(createView, "Rent Increase Annually With RPI", backLink)
