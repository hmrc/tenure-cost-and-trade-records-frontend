...
class TypeOfTenureViewSpec extends QuestionViewBehaviours[TypeOfTenure]:
  ...
  def createView: () => Html = () => typeOfTenureView(form, Summary("99996010001"))(using getRequest, messages)

  def createViewUsingForm: Form[TypeOfTenure] => Html =
    form => typeOfTenureView(form, Summary("99996010001"))(using getRequest, messages)
