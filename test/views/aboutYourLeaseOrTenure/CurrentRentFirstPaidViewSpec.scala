...
class CurrentRentFirstPaidViewSpec extends QuestionViewBehaviours[LocalDate]:
  ...
  private def createView = () =>
    currentRentFirstPaidView(form, backLink, Summary("99996010001"))(using getRequest, messages)
  ...
  "Current rent first paid view" should {
    ...
    behave like pageWithBackLink(createView, "Current Annual Rent", backLink)
