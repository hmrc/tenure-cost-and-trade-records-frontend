...
class RentIncreaseAnnuallyWithRPIViewSpec extends QuestionViewBehaviours[AnswersYesNo]:
  ...
  private def createView = () =>
    rentIncreaseAnnuallyWithRPIView(form, backLink, Summary("99996010001"))(using getRequest, messages)
  ...
  "Rent Increase annually with RPI view" should {
    ...
    behave like pageWithBackLink(createView, "Rent Open Market Value", backLink)
