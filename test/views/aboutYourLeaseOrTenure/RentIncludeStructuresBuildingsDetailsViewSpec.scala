...
class RentIncludeStructuresBuildingsDetailsViewSpec extends QuestionViewBehaviours[String]:
  ...
  private def createView = () =>
    rentIncludeStructuresBuildingsDetailsView(form, Summary("99996010001"))(using getRequest, messages)

  private def createViewUsingForm = (form: Form[String]) =>
    rentIncludeStructuresBuildingsDetailsView(form, Summary("99996010001"))(using getRequest, messages)

  "RentIncludeStructuresBuildingsDetails view" should {

    behave like normalPage(createView, messageKeyPrefix)

    behave like pageWithBackLink(
      createView,
      "Rent Include Structures Buildings",
