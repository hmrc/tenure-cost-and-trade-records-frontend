...
class TenantsAdditionsDisregardedViewSpec extends QuestionViewBehaviours[AnswersYesNo]:
  ...
  private def createView = () =>
    tenantsAdditionsDisregardedView(form, backLink, Summary("99996010001"))(using getRequest, messages)
  ...
  "Tenants additions disregarded view" should {
    ...
    behave like pageWithBackLink(createView, "Incentives Payments Conditions", backLink)
