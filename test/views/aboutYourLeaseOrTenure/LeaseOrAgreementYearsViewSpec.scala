...
class LeaseOrAgreementYearsViewSpec extends QuestionViewBehaviours[LeaseOrAgreementYearsDetails]:
  ...
  private def createView = () =>
    leaseOrAgreementYearsView(form, backLink, Summary("99996010001"))(using getRequest, messages)
  ...
  "Lease or agreement years view" should {
    ...
    behave like pageWithBackLink(createView, "About Your Landlord", backLink)
