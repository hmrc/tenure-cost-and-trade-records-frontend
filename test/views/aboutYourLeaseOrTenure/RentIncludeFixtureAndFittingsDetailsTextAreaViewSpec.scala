...
class RentIncludeFixtureAndFittingsDetailsTextAreaViewSpec extends QuestionViewBehaviours[String]:
  ...
  override val form: Form[String] = RentIncludeFixtureAndFittingDetailsTextAreaForm.rentIncludeFixtureAndFittingsDetailsTextAreaForm

  private def createView = () =>
    rentIncludeFixtureAndFittingsDetailsTextAreaView(form, Summary("99996076001"))(using getRequest, messages)
  ...
  "Fixture and fittings details" should {
    ...
    behave like pageWithBackLink(
      createView,
      "Rent Include Fixture And Fittings",
