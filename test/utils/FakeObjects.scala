...
import models.submissions.Form6010.{LettingOtherPartOfPropertiesNo, CateringAddress, CateringOperationOrLettingAccommodationDetails, CateringOperationOrLettingAccommodationRentDetails, FranchiseOrLettingsTiedToPropertiesYes, LandlordAddress, LettingAddress, LettingOtherPartOfPropertiesYes, LettingOtherPartOfPropertyInformationDetails, LettingOtherPartOfPropertyRentDetails, FranchiseOrLettingsTiedToPropertiesNo}
...
import models.submissions.aboutfranchisesorlettings.{AboutFranchisesOrLettings, CateringOperationOrLettingAccommodationSection, CateringOperationNo, CateringOperationYes, LettingSection}
