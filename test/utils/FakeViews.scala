...
trait FakeViews { this: Injecting =>
  ...
  lazy val genericRemoveConfirmationView: genericRemoveConfirmation = inject[genericRemoveConfirmation]
...
//  val confirmationNotConnectedView: confirmationNotConnected                                      = inject[confirmationNotConnected]
  ...
  lazy val addedMaximumListItemsView: addedMaximumListItems                 = inject[addedMaximumListItems]
  ...
  lazy val whenDidYouFistOccupyView: whenDidYouFirstOccupy                                          = inject[whenDidYouFirstOccupy]
  ...
  lazy val checkYourAnswersAccountingInfoView: checkYourAnswersAccountingInfo                       = inject[checkYourAnswersAccountingInfo]
  ...
  lazy val isRentReviewPlannedView                          = inject[isRentReviewPlanned]
