...
import views.html.requestReferenceNumber.{confirmationRequestReferenceNumber, checkYourAnswersRequestReferenceNumber, confirmationRequestReferenceNumber, requestReferenceNumber, requestReferenceNumberContactDetails}
