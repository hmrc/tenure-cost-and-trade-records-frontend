...
class AddressesSpec extends AnyFlatSpec with Matchers {
  // Test Address
  ...
  "CateringAddress" should "return the address as a single line" in {
    val result = cateringAddress.singleLine
    result shouldBe "001, GORING ROAD, GORING-BY-SEA, WORTHING, SUSSEX, BN12 4AX"
  }

  "CateringAddress" should "return the address as a multi line" in {
  ...
  "LandlordAddress" should "return the address as a single line" in {
    val result = landAddress.singleLine
    result shouldBe "001, GORING ROAD, GORING-BY-SEA, WORTHING, SUSSEX, BN12 4AX"
  }

  "LandlordAddress" should "return the address as a multi line" in {
  ...
  "LettingAddress" should "return the address as a single line" in {
    val result = lettingAddress.singleLine
    result shouldBe "001, GORING ROAD, GORING-BY-SEA, WORTHING, SUSSEX, BN12 4AX"
  }

  "LettingAddress" should "return the address as a multi line" in {
