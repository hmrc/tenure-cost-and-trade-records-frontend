...
class PlantAndTechnologyController @Inject() (
  ...
  private def calculateBackLink(implicit request: SessionRequest[AnyContent]) =
    request.sessionData.aboutYouAndTheProperty
      ...
      case Some(AnswerYes) =>
        controllers.aboutyouandtheproperty.routes.ThreeYearsConstructedController
          .show()
          .url // TODO SHOULD TAKE TO PROVIDE A BREAKDOWN PAGE BUT THIS SCREEN IS NOT IMPLEMENTED YET 15/05
      case Some(AnswerNo)  =>
