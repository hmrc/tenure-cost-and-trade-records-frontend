...
class CheckYourAnswersAboutTheTradingHistoryController @Inject() (
  ...
  private def getBackLink(answers: Session): String =
    answers.forType match {
      ...
      case ForTypes.for6015 | ForTypes.for6030                    => controllers.aboutthetradinghistory.routes.UnusualCircumstancesController.show().url
      case ForTypes.for6020                                       =>
        controllers.aboutthetradinghistory.routes.ElectricVehicleChargingPointsController.show().url
      case ForTypes.for6045 | ForTypes.for6046                    => // TODO: Static caravans OR What is the current annual pitch fee for a single-unit static caravan
