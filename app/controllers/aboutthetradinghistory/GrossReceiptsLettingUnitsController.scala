...
import form.aboutthetradinghistory.GrossReceiptsLettingUnitsForm.grossReceiptsLettingUnitsForm
import models.submissions.aboutthetradinghistory.AboutTheTradingHistoryPartOne.updateAboutTheTradingHistoryPartOne
import models.submissions.aboutthetradinghistory.{GrossReceiptsLettingUnits, TurnoverSection6045}
import navigation.AboutTheTradingHistoryNavigator
import navigation.identifiers.GrossReceiptsHolidayUnitsId
import play.api.i18n.I18nSupport
import play.api.mvc.{Action, AnyContent, MessagesControllerComponents, Result}
import repositories.SessionRepo
import views.html.aboutthetradinghistory.grossReceiptsLettingUnits6045

import javax.inject.{Inject, Named, Singleton}
import scala.concurrent.{ExecutionContext, Future}

@Singleton
class GrossReceiptsLettingUnitsController @Inject() (
  mcc: MessagesControllerComponents,
  navigator: AboutTheTradingHistoryNavigator,
  view: grossReceiptsLettingUnits6045,
  ...
  private def getBackLink(implicit request: SessionRequest[AnyContent]): String =
    navigator.from match {
      ...
      case _     => aboutthetradinghistory.routes.OtherHolidayAccommodationDetailsController.show().url
    }
