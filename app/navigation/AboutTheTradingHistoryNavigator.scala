...
class AboutTheTradingHistoryNavigator @Inject() (audit: Audit) extends Navigator(audit) with Logging {
  ...
  private def financialYearEndRouting: Session => Call = { s =>
    ...
    then
      routes.CheckYourAnswersFinancialYearEndController.show()
    else
      ...
      case _ =>
        s.forType match {
          ...
          case FOR6010 | FOR6011 | FOR6015 | FOR6016 | FOR6045 | FOR6046 | FOR6048 =>
            routes.CheckYourAnswersAccountingInfoController.show
  ...
  override val routeMap: Map[Identifier, Session => Call] = Map(
    ...
    SingleCaravansAgeCategoriesId               -> (_ =>
      routes.TwinUnitCaravansOwnedByOperatorController.show()
    ),
    ...
    TentingPitchesCertificatedId                -> (_ =>
      routes.CheckYourAnswersTentingPitchesController.show()
    ),
