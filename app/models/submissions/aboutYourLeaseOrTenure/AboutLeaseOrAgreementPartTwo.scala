...
import models.submissions.Form6010.{CanRentBeReducedOnReviewDetails, HowIsCurrentRentFixed, IncentivesPaymentsConditionsDetails, IntervalsOfRentReview, LegalOrPlanningRestrictions, LegalOrPlanningRestrictionsDetails, MethodToFixCurrentRentDetails, PayACapitalSumDetails, PaymentWhenLeaseIsGrantedDetails, RentPayableVaryAccordingToGrossOrNetDetails, RentPayableVaryAccordingToGrossOrNetInformationDetails, RentPayableVaryOnQuantityOfBeersDetails, RentPayableVaryOnQuantityOfBeersInformationDetails, TenancyLeaseAgreementDetails, TenantAdditionsDisregardedDetails, TenantsAdditionsDisregardedDetails}
