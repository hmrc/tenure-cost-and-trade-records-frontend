...
case class SensitiveRequestAddress(buildingNameNumber: SensitiveString,
...
object SensitiveRequestAddress{
  import crypto.SensitiveFormats._
  implicit def format(implicit crypto: MongoCrypto): OFormat[SensitiveRequestAddress] = Json.format[SensitiveRequestAddress]
