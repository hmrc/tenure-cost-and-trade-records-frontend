...
object AddAnotherCateringOperationOrLettingAccommodationYes extends AddAnotherCateringOperationOrLettingAccommodations {
  val name = "yes"
}
object AddAnotherCateringOperationOrLettingAccommodationNo extends AddAnotherCateringOperationOrLettingAccommodations {
  val name = "no"
}
