...
import models.submissions.aboutYourLeaseOrTenure.{AboutTheLandlord, ConnectedToLandlord, CurrentRentFirstPaid, CurrentRentPayableWithin12Months, LeaseOrAgreementYearsDetails}
