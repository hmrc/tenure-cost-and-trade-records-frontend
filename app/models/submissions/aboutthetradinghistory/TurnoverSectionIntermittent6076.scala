...
/**
  ...
  */
case class TurnoverSectionIntermittent6076(
...
object TurnoverSectionIntermittent6076 {
  implicit val format: OFormat[TurnoverSectionIntermittent6076] = Json.format
}
