...
import models.submissions.connectiontoproperty.{AddressConnectionType, ConnectionToProperty, EditAddress, NoReferenceNumber, NoReferenceNumberAddress, VacantProperties, VacantPropertiesDetails}
