...
/**
  ...
  */
object AccommodationUnit6048Form:

  val accommodationUnit6048Form: Form[(String, String)] =
    Form(
      tuple(
        "unitName" -> default(text, "").verifying(
          nonEmpty(errorMessage = "error.accommodation.unitName.required"),
