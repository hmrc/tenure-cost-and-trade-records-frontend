...
turnover.6048.accountingCosts.wagesAndNationalInsurance.required = Enter 0 if you did not have any Wages and National Insurance costs in the year ending {0}
turnover.6048.accountingCosts.wagesAndNationalInsurance.range = Wages and National Insurance costs in the year ending {0} must be a number, for example 100 or 100.00
turnover.6048.accountingCosts.wagesAndNationalInsurance.negative = Wages and National Insurance costs in the year ending {0} cannot be a negative number
turnover.6048.accountingCosts.depreciationBuildings.required = Enter 0 if you did not have any depreciation buildings costs in the year ending {0}
turnover.6048.accountingCosts.depreciationBuildings.range = Depreciation buildings costs in the year ending {0} must be a number, for example 100 or 100.00
turnover.6048.accountingCosts.depreciationBuildings.negative = Depreciation buildings costs in the year ending {0} cannot be a negative number
turnover.6048.accountingCosts.depreciationContents.required = Enter 0 if you did not have any depreciation contents costs in the year ending {0}
turnover.6048.accountingCosts.depreciationContents.range = Depreciation contents costs in the year ending {0} must be a number, for example 100 or 100.00
turnover.6048.accountingCosts.depreciationContents.negative = Depreciation contents costs in the year ending {0} cannot be a negative number
turnover.6048.accountingCosts.bookkeepingOrAccountancy.required = Enter 0 if you did not have any bookkeeping or accountancy costs in the year ending {0}
turnover.6048.accountingCosts.bookkeepingOrAccountancy.range = Bookkeeping or accountancy costs in the year ending {0} must be a number, for example 100 or 100.00
turnover.6048.accountingCosts.bookkeepingOrAccountancy.negative = Bookkeeping or accountancy costs in the year ending {0} cannot be a negative number
turnover.6048.accountingCosts.bankCharges.required = Enter 0 if you did not have any bank charges in the year ending {0}
turnover.6048.accountingCosts.bankCharges.range = Bank charges in the year ending {0} must be a number, for example 100 or 100.00
turnover.6048.accountingCosts.bankCharges.negative = Bank charges in the year ending {0} cannot be a negative number
...
commercialLettingAvailability.declare = Declare how many nights your property was available for letting commercially - in periods not longer than 28 nights - within the stated. This includes any nights when the property was vacant, even though it was open for commercial lettings.
...
confirmation.unableToRetrieveAnswers = You will not be able to:
