...
taskList.status.completed = Declaration completed
taskList.status.incomplete = Declaration incomplete
taskList.status.description = You have completed {0} of {1} sections.
