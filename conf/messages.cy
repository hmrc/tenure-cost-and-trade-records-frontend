...
turnover.alcoholicDrinks = Diodydd (heb gynnwys TAW)
turnover.alcoholicDrinksCaption = Gan gynnwys diodydd alcoholaidd a diodydd ysgafn, creision, cnau
turnover.food = Bwyd (heb gynnwys TAW)
turnover.foodCaption = Heb gynnwys diodydd
turnover.otherReceipts = Derbynebau eraill (heb gynnwys TAW)
...
turnover.totalSalesRevenue = Cyfanswm refeniw y gwerthiannau
turnover.totalSalesRevenueCaption = (heb gynnwys TAW)
turnover.accommodation = Llety (heb gynnwys TAW)
...
grossReceiptsForBaseLoad.renewableHeatIncentiveBioMethane = Diwedd y flwyddyn ariannol
