...
turnover.6076.furtherInformationOrRemarks.hint = Include any information you think may be relevant but has not be covered.
...
error.turnover.6076.headOfficeExpenses.required = Enter 0 if you did not have any contributions towards head office expenses in the year ending {0}
...
costOfSales6076.p = Provide us with details of your cost of sales. If your accounts are held in a spreadsheet that mirrors this form, you can copy and paste them into this form. Copy the relevant figures in your spreadsheet and paste them into the first corresponding field on this page.
