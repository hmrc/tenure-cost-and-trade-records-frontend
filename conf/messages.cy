...
##########################################
label.connectionToProperty.confirm.heading = Declaration sent successfully
label.connectionToProperty.emailConfirm = We have sent you a confirmation email.
label.connectionToProperty.saveCopyOfAnswers.1 = Save a copy of your answers
label.connectionToProperty.saveCopyOfAnswers.2 = (print or PDF download)
label.connectionToProperty.unableToRetrieveAnswers = You will be unable to retrieve your answers beyond this point
label.connectionToProperty.whatNext = What happens next
connectionToProperty.confirm.copy.list.1 = We have sent your application to the Valuation Office Agency.
connectionToProperty.confirm.copy.list.2 = They may need to contact you for further information.
...
checkYourAnswersAboutTheProperty.aboutProperty.heading = Property use
