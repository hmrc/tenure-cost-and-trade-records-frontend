...
error.costOfSales6076.importedPower.required = Enter 0 if you did not have any other costs in the year ending {0}
error.costOfSales6076.importedPower.range = Other costs in the year ending {0} must be a number, for example 100 or 100.00
error.costOfSales6076.importedPower.negative = Other costs in the year ending {0} cannot be a negative number
